 ...
 *
 * @description This script is used to copy documentation files from one directory to another. It can be configured to remove the destination folder before copying.
 */
